...
const ROLE_DASHBOARD = {
  ...
  ACCOUNTANT   : 'accounts/accounts.html',
  CASHIER      : 'restaurant/cashier-dashboard.html',
  CHEF         : 'restaurant/chef-dashboard.html',
  WAITER       : 'employee-dashboard.html',
  STORE_MANAGER: 'inventory/inventory.html',
  CEO          : 'Ceo-dashboard.html',
  MD           : 'owner-dashboard.html',
  CLIENT       : 'Dashboard.html',
  DEMO         : 'dashboard.html',
  ACCT         : 'balaji-staff-portal.html',
  PARTTIME     : 'employee-dashboard.html',
  STAFF        : 'employee-dashboard.html',
  HR           : 'manager-dashboard.html',
  SUPERVISOR   : 'manager-dashboard.html',
  DEFAULT      : 'main_dashboard.html',
};
...
const INDUSTRY_DASHBOARD = {
  ...
  CAFE       : 'dashboard.html',
  TEA        : 'restaurant/restaurant-dashboard.html',
  RETAIL     : 'restaurant/restaurant-dashboard.html'',
  GROCERY    : 'dashboard.html'',
  SUPERMARKET: 'dashboard.html'',
