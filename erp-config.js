...
const ERP = {
  ...
  goToDashboard(){
    ...
    if (skip) {
      ...
      var _isAlreadyOnSelector = _curPath.includes('welcome') || _curPath.includes('dashboard') || _curPath.includes('welcome.html');
      if (!_isAlreadyOnSelector) {
        _safeNavigate('Dashboard/restaurant/Welcome.html');
      }
    }
  },
